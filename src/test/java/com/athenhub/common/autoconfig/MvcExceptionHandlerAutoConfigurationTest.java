...
public class MvcExceptionHandlerAutoConfigurationTest {
    ...
    void defaultAutoConfigurationWorks() {
        contextRunner.run(context -> {
            ...
            assertThat(context.getBean(MessageResolver.class)).isInstanceOf(MessageSourceResolver.class);
        });
    }
    ...
    void customMvcExceptionHandlerBeanExists() {
        contextRunner
                ...
                .run(context -> {
                    assertThat(context).hasSingleBean(MvcExceptionHandler.class);
                    assertThat(context.getBean(MvcExceptionHandler.class)).isInstanceOf(CustomHandler.class);
                });
    }
    ...
    void customMessageResolverBeanExists() {
        contextRunner
                ...
                .run(context -> {
                    assertThat(context).hasSingleBean(MessageResolver.class);
                    assertThat(context.getBean(MessageResolver.class)).isInstanceOf(CustomMessageResolver.class);
                    assertThat(context).hasSingleBean(MvcExceptionHandler.class);
                });
    }
    ...
    static class CustomHandler extends MvcExceptionHandler {
        public CustomHandler() { super(null); }
    }
